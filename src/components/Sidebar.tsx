...
import { LayoutDashboard, Search, Bookmark, Settings, CreditCard, LogOut, Zap } from 'lucide-react';
...
export default function Sidebar({ currentView, onViewChange }: SidebarProps) {
  ...
  return (
    <aside className="w-60 border-r border-brand-border bg-[#080808] flex flex-col h-screen fixed left-0 top-0 z-50 font-sans">
      <div className="p-6">
